...
const messages = defineMessages({
	title: {
		...
		defaultMessage: 'Packrinth update required',
	},
	description: {
		id: 'app.hosting.update-required.description',
		defaultMessage: 'You need to update to use Modrinth Hosting through Packrinth',
	},
	downloadToUpdate: {
	...
	excitedRinthbotAlt: {
		...
		defaultMessage: 'Excited Packrinth Bot',
	},
})
