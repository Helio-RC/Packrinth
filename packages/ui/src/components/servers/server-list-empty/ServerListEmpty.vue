...
const messages = defineMessages({
	...
	noServersDescription: {
		...
		defaultMessage: 'Install mods, invite friends, and play together all from Packrinth.',
	},
	...
	playWithFriendsDescription: {
		...
		defaultMessage: 'Invite friends to play your server with one-click play from Packrinth.',
	},
	newServerButton: {
